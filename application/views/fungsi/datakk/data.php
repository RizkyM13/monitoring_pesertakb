            ...
            <hr>
              <section id="unseen">
                <table class="table table-bordered table-striped table-condensed" id="hidden-table-info">
                  ...
                  <tr>
                      <th>No</th>
                      <th onclick="sortTable(1)">Nomor KK</th>
                      <th onclick="sortTable(0)">Tanggal KK</th>
                      <th onclick="sortTable(1)">Status KK</th>
                      <th onclick="sortTable(0)">Last Update</th>
                      <th onclick="sortTable(1)">Last Update By</th>
                      <th>Aksi</th>
                  </tr>
                </thead>
                <tbody>
