...
<div class="form-panel">
               ...
               <a href="<?php echo base_url() . 'kontrasepsi/tambah'; ?>" class="btn btn-primary right" accesskey="t">Tambah Data</a>
                  ...
                  <tr>
                    <?php
                      ...
                      <td>
                        ...
                        <a href="<?php echo base_url() . 'kontrasepsi/edit'; ?>/<?php echo $item->kontrasepsi_id ?>" class="btn btn-primary btn-xs">
