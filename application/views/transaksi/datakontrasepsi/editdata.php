              ...
              <form class="form-horizontal style-form" method="post" action="<?php echo base_url() . 'transaksi/datakontrasepsi/update'; ?>">
                ...
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Kode Kontrasepsi</label>
                    <div class="col-sm-10">
                      <input type="number" name="kontrasepsi_kode" class="form-control" placeholder="Masukkan Kode Kontrasepsi" value="<?php echo $v_kontrasepsi['kontrasepsi_kode'] ?>">
                    </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Nama Kontrasepsi</label>
                    <div class="col-sm-10">
                      <input type="text" name="kontrasepsi_nama"class="form-control" placeholder="Masukkan Nama Kontrasepsi" value="<?php echo $v_kontrasepsi['kontrasepsi_nama'] ?>">
                    </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Expired Kontrasepsi</label>
                    <div class="col-sm-10">
                      <input type="number" name="kontrasepsi_expired"class="form-control" placeholder="Masukkan Expired Kontrasepsi Dalam Satuan Hari" value="<?php echo $v_kontrasepsi['kontrasepsi_expired'] ?>">
                    </div>
                </div>
                <div class="form-group">
