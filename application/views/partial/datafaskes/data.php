            ...
            <div class = "span6">     
              <div id = "hidden-table-info_filter" class="dataTables_filter">
                <div class="navbar-form navbar-right">
                  <form class="form-inline my-2 my-lg-0" action = "<?php echo base_url() . 'setting/faskes/search' ?>" method ="post">
            ...
            <br>
              ...
              <section id="unseen">
                <table class="table table-bordered table-striped table-condensed" id="hidden-table-info">
                  ...
                  <tr>
                      <th>No</th>
                      <th onclick="sortTable(1)">ID Faskes</th>
                      <th onclick="sortTable(1)">ID Faaskes Jenis</th>
                      <th onclick="sortTable(1)">Kode Faskes</th>
                      <th onclick="sortTable(0)">Nama Faskes</th>
                      <th onclick="sortTable(0)">Alamat Faskes</th>
                      <th onclick="sortTable(1)">Kode Desa</th>
                      <th onclick="sortTable(1)">Faskes Aktif</th>
                      <th>Aksi</th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  ?>
                      ...
                      <td>
                        <button class="btn btn-success btn-xs">
                          ...
                          <a href="<?php echo base_url() . 'setting/faskes/edit'; ?>/<?php echo $item->faskes_id ?>" class="btn btn-primary btn-xs">
                              <i class="fa fa-pencil"></i>
                          </a>
                          
                          <a href="<?php echo base_url() . 'setting/faskes/hapus';?>/<?php echo $item->faskes_id?>" class="btn btn-danger btn-xs" onclick="return confirm('Yakin Menghapus Data?')">
