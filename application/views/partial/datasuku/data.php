            ...
            <div class = "span6">     
              <div id = "hidden-table-info_filter" class="dataTables_filter">
                <div class="navbar-form navbar-right">
                  <form class="form-inline my-2 my-lg-0" action = "<?php echo base_url() . 'master-data/ms_suku/search' ?>" method ="post">
              ...
              <section id="unseen">
                <table class="table table-bordered table-striped table-condensed" id="hidden-table-info">
                  ...
                  <tr>
                      ...
                      <th onclick="sortTable(0)">Kode Suku</th>
                      <th onclick="sortTable(0)">Nama Suku</th>
                      <th onclick="sortTable(1)">Suku Aktif</th>
                      <th>Aksi</th>
                  </tr>
                </thead>
                <tbody>
