...
<div id="hidden-table-info_wrapper" class="dataTables_wrapper form-inline" role="grid">
               ...
               <a href="<?php echo base_url() . 'setting/group_menu/tambah'; ?>" class="btn btn-primary right">Tambah Data</a>
            ...
            <div class = "span6">     
              <div id = "hidden-table-info_filter" class="dataTables_filter">
                <div class="navbar-form navbar-right">
                  <form class="form-inline my-2 my-lg-0" action = "<?php echo base_url() . 'setting/group_menu/search' ?>" method ="post">
            ...
            <hr>
              <section id="unseen">
                <table class="display table table-bordered" id="hidden-table-info">
                  ...
                  <tr role="row">
                      <th>No</th>
                      <th onclick="sortTable(1)">ID Menu
                      </th>

                      <th onclick="sortTable(1)">ID Group
                      </th>

                      <th onclick="sortTable(1)">Update By
                      </th>

                      <th onclick="sortTable(1)">Update Time
                      </th>
                ...
                <tbody role="alert" aria-live="polite" aria-relevant="all">
                  <tr>
                    <?php
                      ...
                      <td>
                        <a href="<?php echo base_url() . 'setting/group_menu/menu'; ?>/<?php echo $item->menu_id ?>"class="btn btn-success btn-xs">
                            <i class="fa fa-check"></i>
                        </a>
                          <a href="<?php echo base_url() . 'setting/group_menu/edit'; ?>/<?php echo $item->menu_id ?>" class="btn btn-primary btn-xs">
